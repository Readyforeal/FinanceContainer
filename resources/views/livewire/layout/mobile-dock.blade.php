...
<div x-data="{ expanded: false, path: window.location.pathname }" @popstate.window="path = window.location.pathname" x-init="document.addEventListener('livewire:navigated', () => {
    ...
    <div class="fixed bottom-3 left-3 right-3 z-40">
        <div
            class="flex items-center justify-around bg-white/50 dark:bg-zinc-900/50 backdrop-blur-xl rounded-full shadow-lg shadow-zinc-300/30 dark:shadow-zinc-950/40 border border-zinc-200/50 dark:border-zinc-700/50 px-2 py-2.5">
